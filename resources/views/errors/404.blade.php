...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ Vite::image('images/favicon.ico') }}">

    <!-- Plugins CSS -->
    <link rel="stylesheet" type="text/css" href="{{ Vite::asset('resources/assets/vendor/font-awesome/css/all.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ Vite::asset('resources/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ Vite::asset('resources/assets/vendor/tiny-slider/tiny-slider.css') }}">

    <!-- Theme CSS -->
    <link id="style-switch" rel="stylesheet" type="text/css" href="{{ Vite::asset('resources/css/style-rtl.css') }}">
...
<div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
    <div class="row">
        <div class="col-md-12 text-center position-relative z-index-9">
            <!-- SVG shape START -->
            ...
            <a href="{{ route('index') }}" class="btn btn-danger-soft mt-3"><i class="fas fa-long-arrow-alt-left me-3"></i>برگشت به خانه</a>
        </div>
    </div>
</div>
<!-- =======================
...
<!-- Bootstrap JS -->
<script src="{{ Vite::asset('resources/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
