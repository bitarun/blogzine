...
@section('content')
    ...
    <main>
      ...
      Main contain START -->
        <section class="py-4">
            <div class="container">
                @include('dashboard.patrials.category.create')
                <div class="row pb-4">
                    <div class="col-12">
                        <!-- Title -->
                        <div class="d-sm-flex justify-content-sm-between align-items-center">
                            <h1 class="mb-2 mb-sm-0 h3">دسته بندی ها <span
                                    class="badge bg-primary bg-opacity-10 text-primary">{{ $categoryCount }}</span></h1>
                        </div>
                    </div>
                </div>
                <div class="row g-4">
                    @if($categories)
                                ...
                                <div class="card border h-100">
                                    ...
                                    <div class="card-header border-bottom p-3">
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="icon-lg shadow bg-body rounded-circle">{{ $category->icon }}</div>
                                            <h4 class="mb-0 ms-3">{{ $category->name }}</h4>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="{{ route('category.edit', $category) }}"
                                                   class="text-success mb-0 me-2"><i class="fas fa-edit"></i></a>
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <!-- Total post -->
                                            <div>
                                                <h5 class="mb-0">{{ $category->articles_count }}</h5>
                                            ...
                                            <ul class="avatar-group mb-0">
                                                <li class="avatar avatar-xs">
                                                    <img class="avatar-img rounded-circle"
                                                         src="{{ Vite::image('avatar/01.jpg') }}" alt="avatar">
                                                </li>
                                                <li class="avatar avatar-xs">
                                                    <img class="avatar-img rounded-circle"
                                                         src="{{ Vite::image('avatar/02.jpg') }}" alt="avatar">
                                                </li>
                                                <li class="avatar avatar-xs">
                                                    <img class="avatar-img rounded-circle"
                                                         src="{{ Vite::image('avatar/03.jpg') }}" alt="avatar">
                                                </li>
                                                <li class="avatar avatar-xs">
                        ...
                        {{ $categories->links() }}
                    @else
                        <div class="alert alert-info">تا این لحظه دسته‌بندی ثبت نشده است. بای ثبت دسته‌بندی دکمه‌ی از
                            کادر بالا اقدام نمائید.
                        </div>
                    @endif
                    <div class="col-12">
                        ...
                        <div class="card border bg-transparent rounded-3">
                            ...
                            <div class="card-header bg-transparent border-bottom p-3">
                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                    ...
                                    <a href="#" class="btn btn-sm btn-primary mb-0"><i class="fas fa-plus me-2"></i>ثبت
                                        خبر جدید</a>
                                </div>
                            </div>
                            <!-- Card header END -->
                                ...
                                <div class="table-responsive border-0">
                                    <table class="table table-dark-gray align-middle p-4 mb-0 table-hover table-shrink">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a href="#" class="btn btn-light btn-round mb-0"
                                                       ...
                                                       title="ویرایش"><i class="bi bi-pencil-square"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">رازهای کوچک کثیف
                                                        در مورد صنعت تجارت</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-warning bg-opacity-15 text-warning mb-2">پیش نویس</span>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                                <div class="d-flex gap-2">
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">طرح مجلس برای
                                                        گرفتن مالیات از سفته بازها</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">عادات بدی که
                                                        افراد در صنعت باید آنها را ترک کنند!</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-warning bg-opacity-10 text-warning mb-2">پیش نویس</span>
                                            </td>
                                            <!-- Table data -->
                                            <td>
                                                <div class="d-flex gap-2">
                                        ...
                                        <tr>
                                            <!-- Table data -->
                                            <td>
                                                <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#">سال 2022 رویایی و
                                                        فوق العاده برای طارمی</a></h6>
                                            </td>
                                            <!-- Table data -->
                                            <td>
