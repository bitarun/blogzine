                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="con-name" name="title" type="text"
                                                       ...
                                                       placeholder="عنوان خبر" value="{{ old('title') }}">
                                                @error('title')
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea id="newsBody"
                                                          ...
                                                          name="body"
                                                          style="min-height: 300px">{{ old('body') }}</textarea>
                                                @error('body')
                                                <small class="mt-2 d-inline-block text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control @error('slug') border-danger @enderror"
                                                       name="slug" placeholder="نامک ..." value="{{ old('slug') }}">
                                                @error('slug')
                                                <small class="mt-2 d-inline-block text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea
                                                    ...
                                                    placeholder="توضیح مختصری را درباره خبر بنویسید...">{{ old('description') }}</textarea>
                                                @error('description')
                                                <small class="mt-2 d-inline-block text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <label for="fileInput" class="w-100" style="cursor:pointer;">
                                                    <div class="input-group flex-row-reverse">
                                                        <input type="text" class="form-control upload-name" readonly/>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('tags') border-danger @enderror"
                                                      name="tags" rows="1"
                                                      placeholder="ورزش، اقتصاد، ...">{{ old('tags') }}</textarea>
                                            @error('tags')
                                            <small class="mt-2 d-inline-block text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
