...
<head>
    ...
    {{--<script src="https://lib.arvancloud.ir/tinymce/6.3.2/tinymce.min.js
            ...
            <div {{--class="collapse navbar-collapse"--}} id="navbarCollapse">
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active p-2" href="#">خانه</a>
                    </li>
                    @if($menuCategories->isNotEmpty())
                        @foreach($menuCategories as $menuCategory)
                            <li class="nav-item dropdown">
                                <a class="nav-link p-2"
                                   href="{{ route('archive', $menuCategory) }}">{{ $menuCategory->name }}</a>
                            </li>
                        @endforeach
                    @endif
                    <li class="nav-item dropdown">
                        <a class="nav-link p-2" href="#">درباره ما</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link p-2" href="#">تماس ما</a>
                    </li>
            ...
            <div class="nav flex-nowrap align-items-center">
                ...
                @auth()
                    ...
                    <div class="nav-item align-self-end">
                        <a id="openedSidebar" class="nav-link p-0" data-bs-toggle="offcanvas" href="#offcanvasMenu"
                ...
                @guest()
                    <a href="{{ route('login') }}" class="btn btn-success btn-sm ml-2">ورود</a>
